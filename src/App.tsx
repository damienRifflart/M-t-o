    ...
    <>
      ...
      <section id="accueil" className='w-full mt-[10rem]'>
        <div className='flex justify-center'>
          ...
          <motion.div className='absolute bottom-[14rem] right-[5rem]'
            ...
            transition={{ duration: 1.5 }}
          >
            <img src="cloud.png" alt="Sun" className='w-[10rem] absolute'/>
          ...
          <div className='flex flex-col text-center z-10 flex items-center'>
            ...
            <motion.button className='bg-[var(--bg)] w-fit mt-[5rem] py-2 px-7 rounded-2xl border-2 border-[var(--accent)]'
              animate={{
                scale: [0, 1, 1.01, 1],
                opacity: [0, 100],
              }}
            ...
            >
              <a href="#inscription" className='text-3xl font-bold text-[var(--accent)]'>S'inscrire</a>
            </motion.button>
          </div>
        </div>
      </section>
      ...
      <section id='services' className='w-full mt-[15rem]'>
        ...
        <div className="flex flex-row gap-10 justify-center mt-20">
            ...
            >
              ...
              <div className="flex flex-col w-[28rem] h-[25rem] bg-gradient-to-tr from-gray-600 to-gray-500 rounded-2xl justify-center items-center">
            ...
            >
              ...
              <div className="flex flex-col w-[28rem] h-[25rem] bg-gradient-to-tr from-[var(--bg)] to-[#ffe536] rounded-2xl justify-center items-center">
      ...
      <section id="inscription" className='w-full mt-[10rem]'>
        ...
        <div className="flex absolute right-[19rem]">
          <button className='bg-[#1e293b] py-2 px-7 rounded-md border-2 border-[var(--accent)] text-3xl'>S'inscrire</button>
        </div>

      </section>

      <footer className='w-full mt-[10rem]'>
